...
import cn.edu.hqu.javaee.chapter4_3.Chapter43Application;
import cn.edu.hqu.javaee.chapter4_3.controller.formEntity.LoginForm;
import cn.edu.hqu.javaee.chapter4_3.controller.formEntity.RegisterForm;
import cn.edu.hqu.javaee.chapter4_3.entity.Hquer;
import cn.edu.hqu.javaee.chapter4_3.service.HquerService;
		...
		if (errors.hasErrors())
			...
			if (!hquerService.register(hquer)) {
				...
				Files.copy(registerForm.getPicFile().getInputStream(),
						Paths.get(Chapter43Application.ROOT, hquer.getUserName() + ".jpeg"),
